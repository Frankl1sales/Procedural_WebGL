...
import { setupQuadrantLines, drawQuadrants } from './utils.js';
...
async function main() {
  ...
  const numWindmills = 10; // Number of windmills to render
  ...
  // Configure quadrant lines
  const { lineBuffer, lineCount } = setupQuadrantLines(gl);
  ...
  function render(time) {
    ...
    // Chama a função para desenhar os quadrantes
    drawQuadrants(gl, meshProgramInfo, lineBuffer, lineCount);
