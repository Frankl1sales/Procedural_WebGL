...
async function main() {
  ...
  const bannerHref = 'assets/banner_blue.obj';
  // configurações dos avioes
 ...
 // Zed_1
  ...
  const bannerParts = await loadObj(gl, baseHref, meshProgramInfo, bannerHref); // Passa meshProgramInfo
