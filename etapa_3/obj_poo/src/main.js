...
async function main() {
  ...
  const bannerTransforms = createBannerTransforms(numBanners, bannerDistance, bannerRowHeight);
  ...
  const bannerParts = await loadBanner(gl, baseHref, meshProgramInfo); // Passa meshProgramInfo
