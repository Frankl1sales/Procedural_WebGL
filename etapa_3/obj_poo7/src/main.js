...
async function main() {
  ...
  const numWindmills = 100; // Número de banners
  ...
  // Configurações dos Mages
  const numSkeleton_Arrow = 100; // Número de banners
  const Skeleton_ArrowDistance = 20; // Distância entre banners
  ...
  // Configurações dos Mages
  const numSkeleton_Warrior = 100; // Número de banners
  const Skeleton_WarriorDistance = 20; // Distância entre banners
  ...
  const numTrees = 100; // Número de banners
  const TreesDistance = 20; // Distância entre banners
  ...
  const windmillsParts = await loadObj(gl, baseHref, meshProgramInfo, windmillsHref); // Passa meshProgramInfo
  ...
  const TreesParts = await loadObj(gl, baseHref, meshProgramInfo, TreesHref); // Passa meshProgramInfo
